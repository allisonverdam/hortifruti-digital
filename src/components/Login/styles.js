...
export const ButtonLoginGoogle = styled.button`
  align-self: center;
  -moz-box-shadow: 0px 4px 12px -6px #b21d5c;
  -webkit-box-shadow: 0px 4px 12px -6px #b21d5c;
  box-shadow: 0px 4px 12px -6px #b21d5c;
  width: 50%;
  ...
  -webkit-text-decoration: none;
  text-decoration: none;
  text-shadow: 0px 1px 0px #b21d5c;

  &:hover {
    background-color: #b21d5c;
  }
  &:active {
    position: relative;
    top: 1px;
